...
public class ConfirmWithContentDialog extends Dialog implements View.OnClickListener {
    ...
    public ConfirmWithContentDialog(Context context, Callback callback) {
    ...
    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_confirm_with_content, null);
    ...
    public ConfirmWithContentDialog setContent(String cont) {
    ...
    public ConfirmWithContentDialog setToast(String cont) {
        content.setText(cont);
        return this;
    }

    public ConfirmWithContentDialog setSecondContent(String content){
