...
public class AccountUpdater {
    ...
    public static final String ACCOUNT_UPDATED = "com.ezeco.ezwallet.utils.updated";
                ...
                public void doOnBackground() {
                    if(mContext != null) {
                        try {
                            ...
                            AccountUtils.saveAccount(mContext, selectedWallet.getWalletName(), account);
                            AccountUtils.saveAccountNet(mContext, selectedWallet.getWalletName(), accountNetMessage);
                            AccountUtils.saveAccountRes(mContext, selectedWallet.getWalletName(), accountResMessage);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
