package com.ezeco.ezwallet.modules.switchaccount;
...
/** 切换账号 */
public class SwitchWalletActivity extends BaseAcitvity<NormalView, NormalPresenter> implements NormalView {
