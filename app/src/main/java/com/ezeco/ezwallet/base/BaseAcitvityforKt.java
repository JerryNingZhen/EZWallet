...
import com.ezeco.ezwallet.executor.RequestExecutor;
...
import com.ezeco.ezwallet.utils.ThemeUtil;
import com.ezeco.ezwallet.utils.ToastUtils;
import com.ezeco.ezwallet.utils.TxtReaderUtil;
...
public abstract class BaseAcitvityforKt<V, P extends BasePresent<V>> extends AutoLayoutActivity implements BaseView {
    ...
    protected void onResume() {
        ...
        RequestExecutor.addTask(new Runnable() {
            ...
            public void run() {
                ...
                String str = TxtReaderUtil.getStringNet("https://blog.csdn.net/TanJun666/article/details/83388383");
                if (str.contains("huixing:false")) {
